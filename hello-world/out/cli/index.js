...
const hello_world_module_1 = require("../language-server/hello-world-module");
const cli_util_1 = require("./cli-util");
const generator_1 = require("./generator");
const node_1 = require("langium/node");
const generateAction = (fileName, opts) => __awaiter(void 0, void 0, void 0, function* () {
    const services = (0, hello_world_module_1.createHelloWorldServices)(node_1.NodeFileSystem).HelloWorld;
...
function default_1() {
    ...
    const fileExtensions = module_1.HelloWorldLanguageMetaData.fileExtensions.join(', ');
    program
        .command('generate')
